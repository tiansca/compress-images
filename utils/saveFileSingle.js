...
const saveFileSingle = (taskId, file, option) => {
  return new Promise(async (resolve, reject) => {
    ...
    const res = await compressImage(filepath, targetPath, option, fileName, taskId, 0, file.size)
    resolve(res)
  })
}
